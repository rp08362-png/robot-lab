const CACHE='robot-lab-shell-v17';
const ASSETS=['./','./index.html','./styles-v17.css','./app-v17.js','./config-v17.js','./robotlab-v17.webmanifest','./robot-main.jpg','./robotlab-v12-192.png','./robotlab-v12-512.png','./robotlab-v12-maskable-512.png'];
