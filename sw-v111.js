const CACHE='robot-lab-shell-v111';
const ASSETS=['./','./index.html','./styles-v111.css','./app-v111.js','./config-v111.js','./robotlab-v111.webmanifest','./robot-main.jpg','./robotlab-v12-192.png','./robotlab-v12-512.png','./robotlab-v12-maskable-512.png'];
