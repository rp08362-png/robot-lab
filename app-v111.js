import { CONFIG } from './config-v111.js';
...
if('serviceWorker' in navigator) window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v111.js').catch(console.warn));
