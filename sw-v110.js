const CACHE='robot-lab-shell-v110';
const ASSETS=['./','./index.html','./styles-v110.css','./app-v110.js','./config-v110.js','./robotlab-v110.webmanifest','./robot-main.jpg','./robotlab-v12-192.png','./robotlab-v12-512.png','./robotlab-v12-maskable-512.png'];
